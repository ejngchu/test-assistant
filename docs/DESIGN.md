...
> **变更**：去除"三年级"绑定。V1 阶段的"上海小学三年级"定位已被 V2 取代。

## 1. 品牌定位

**产品定位**：面向全年龄段孩子（小学~高中，8-18 岁）的 AI 学习成长伴侣
**核心交互**：单入口——拍错题，全自动——分析/练习/复习
**设计理念**：趣味、友好、鼓励性，帮助孩子建立学习信心
**用户基线**：圆润、温暖、kawaii 风格不变（保留 V1 的视觉资产）
**家长角色**：消费者——看报告、导出打印，不参与孩子的日常操作
